...
public abstract class FreeMarketShop extends Miniroom {
	...
	public FreeMarketShop(Player owner, String desc, byte type) {
	...
	public static class PlayerStore extends FreeMarketShop {
		...
		public PlayerStore(Player owner, String desc, int itemId) {
	...
	public static class HiredMerchant extends FreeMarketShop {
		...
		public byte[] getFirstPersonJoinMessage(Player p, boolean justCreated) {
			Player v;
