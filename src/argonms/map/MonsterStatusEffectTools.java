...
public class MonsterStatusEffectTools {
	...
	private static int applyEffects(Map<MonsterStatusEffect, Short> updatedStats, Mob m, Player p, MonsterStatusEffectsData e) {
	...
	public static void applyEffectsAndShowVisuals(final Mob m, final Player p, final MonsterStatusEffectsData e) {
	...
	public static void dispelEffectsAndShowVisuals(Mob m, Player p, MonsterStatusEffectsData e) {
