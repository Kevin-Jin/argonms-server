...
switch (selection) {
	...
	case 1:
		...
		selection = npc.askAvatar("I can totally change your haircolor and make it look so good. Why don't you change it up a bit? With #b#t51051001##k I'll change it for you. Choose the one to your liking.", hairs);
		item = 5151001;
		take = true;
		styleChange = false;
		break;
