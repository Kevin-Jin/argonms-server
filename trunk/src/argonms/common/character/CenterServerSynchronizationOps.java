...
public class CenterServerSynchronizationOps {
	public static final byte
		...
		GUILD_CREATED = 11,
		CHATROOM_CREATE = 12,
		CHATROOM_ADD_PLAYER = 13,
		CHATROOM_REMOVE_PLAYER = 14,
		CHATROOM_UPDATE_AVATAR_CHANNEL = 15,
		CHATROOM_UPDATE_AVATAR_LOOK = 16,
		CHATROOM_CREATED = 17,
		CHATROOM_ROOM_CHANGED = 18,
		CHATROOM_SLOT_CHANGED = 19
	;
}
