...
public abstract class Minigame extends Miniroom {
	...
	public Minigame(Player owner, String text, String password, byte pieceType) {
	...
	public void setExitAfterGame(Player p, boolean shouldExit) {
	...
	public byte[] getFirstPersonJoinMessage(Player p) {
		Player v;
	...
	public byte[] getThirdPersonJoinMessage(Player p, byte pos) {
		LittleEndianByteArrayWriter lew = new LittleEndianByteArrayWriter();
		lew.writeShort(ClientSendOps.MINIROOM_ACT);
	...
	public static class Omok extends Minigame {
		...
		public Omok(Player owner, String text, String password, byte stoneLook) {
		...
		public void setPiece(Player p, int x, int y, byte playerNum) {
	...
	public static class MatchCards extends Minigame {
		...
		public MatchCards(Player owner, String text, String password, byte size) {
		...
		public void selectCard(Player p, byte turnNo, byte card) {
			if (turnNo == 1) {
				firstSelect = card;
	...
	private static void writeMinigameScores(LittleEndianWriter lew, Player p, MiniroomType type) {
