 ...
 *
 * Talks about Maple Anniversary events.
 *
...
switch (option) {
	case 0:
		...
		break;
	case 1: {
		var game = npc.askMenu(
				"There are many games for this event. It will help you a lot to know how to play the game before you play it. Choose the one you want to know more of!\r\n"
				+ "#b#L0# Ola Ola#l\r\n"
