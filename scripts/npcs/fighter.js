...
if (npc.getPlayerJob() == 0) {
	...
	if (npc.getPlayerLevel() >= 10) {
		...
		if (selection == 1) {
			...
			npc.giveItem(1302077, 1); //Beginner Sword
	...
	if (npc.playerHasItem(4031012, 0) && npc.playerHasItem(4031008, 0)) {
	...
	} else if (npc.playerHasItem(4031012, 0) && npc.playerHasItem(4031008, 1)) {
	...
	} else if (npc.playerHasItem(4031012, 1) && npc.playerHasItem(4031008, 1)) {
...
} else if (Math.floor(npc.getPlayerJob() / 100) == 1) {
